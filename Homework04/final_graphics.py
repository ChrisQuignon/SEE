...
for i in range(len(xs)):
    ...
    pyplot.savefig('img/' + files[i]+'_f.png')
    # pyplot.show()
    pyplot.clf()
...
for i in range(len(xs)):
    ...
    pyplot.savefig('img/' + files[i]+ '_pc_f.png')
    # pyplot.show()
    pyplot.clf()
...
pyplot.savefig('img/BoxplotDistance_f.png',dpi=50)
# pyplot.show()
pyplot.clf()
...
pyplot.savefig('img/BoxplotAngleNorm_f.png',dpi=50)
# pyplot.show()
pyplot.clf()
